        ...
        <c:forEach items="${videoList}" var="vl">
            <div class="col-md-2 resent-grid recommended-grid show-video-grid">
                <div class="resent-grid-img recommended-grid-img">
                    <a href="${pageContext.request.contextPath}/video/frontGet/${vl.vid}"><img height="200px" src="${pageContext.request.contextPath}/images/${vl.pic}" alt="" /></a>
                ...
                <div class="resent-grid-info recommended-grid-info">
                    <h5><a href="${pageContext.request.contextPath}/video/frontGet/${vl.vid}" class="title">${vl.vname}</a></h5>
                    <p class="author">
                        <a href="#" class="author">${vl.author}</a>
                    </p>
                    <p class="views">${vl.area}</p>
                </div>
            </div>
        </c:forEach>
        <div class="clearfix"> </div>
